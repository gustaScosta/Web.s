...
def inicializar_banco():
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS usuarios (
            ...
            nivel TEXT,       -- Iniciante, Intermedi?rio, Avan?ado
            linkedin TEXT,
            github TEXT,
            discord TEXT
        )
    ...
    if cursor.fetchone()[0] == 0:
        # Criar usu?rios de semente
        usuarios_semente = [
            ("Gustavo de Souza Costa", "gustavo@eniac.edu.br", "Estudante de Engenharia de Software no Eniac. Entusiasta de Intelig?ncia Artificial e Front-end.", json.dumps(["React", "HTML", "CSS", "JavaScript"]), "Iniciante", "https://linkedin.com/in/gustavo", "https://github.com/gustavocosta", "gustavo#1234"),
            ("Alysson Oliveira Brito", "alysson@eniac.edu.br", "Desenvolvedor focado em Backend com Python. Gosto de trabalhar em APIs REST e infraestrutura.", json.dumps(["Python", "Flask", "SQL", "Git"]), "Intermedi?rio", "https://linkedin.com/in/alysson", "https://github.com/alyssonbrito", "alysson#5678"),
            ("Pedro Henrique Nemet", "pedro@eniac.edu.br", "Full Stack Developer. Interessado em arquitetura de software e bancos de dados relacionais.", json.dumps(["JavaScript", "Node.js", "SQL", "React", "Python"]), "Avan?ado", "https://linkedin.com/in/pedro", "https://github.com/pedronemet", "pedro#9012")
        ]
        ...
        projetos_semente = [
            ("DevMatch - Plataforma de Conex?o", 
             "Um site para ajudar estudantes e desenvolvedores a encontrar parceiros de estudo e construir portf?lios realistas.", 
             json.dumps(["HTML", "CSS", "JavaScript", "Python", "Flask", "SQL"]), 
             users["Gustavo de Souza Costa"]),
            
            ("API de Gerenciamento de Biblioteca", 
             "Desenvolvimento de uma API robusta para controle de empr?stimos de livros de forma automatizada.", 
             json.dumps(["Python", "Flask", "SQL", "Git"]), 
             users["Alysson Oliveira Brito"]),
            
            ("App de Finan?as Pessoais", 
             "Aplicativo para controle de gastos mensais com gr?ficos interativos e exporta??o de relat?rios.", 
        ...
        print("Banco de dados j? existente e populado.")
